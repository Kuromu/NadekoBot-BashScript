...
if [ $choice -eq 1 ] ; then
	echo ""
	wget -N https://github.com/Kuromu/NadekoBot-BashScript/raw/twinbot/NadekoARN.sh
	cd "$root"
	...
	if [ $choice -eq 2 ] ; then
		echo ""
		wget -N https://github.com/Kuromu/NadekoBot-BashScript/raw/twinbot/NadekoARU_Latest.sh
		cd "$root"
		...
		if [ $choice -eq 3 ] ; then
		echo ""
		wget -N https://github.com/KKuromu/NadekoBot-BashScript/raw/twinbot/nadeko_run.sh
		cd "$root"
