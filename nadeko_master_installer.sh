...
bash "$root/linuxAIO.sh"
						...
						wget -N https://github.com/Kuromu/NadekoBot-BashScript/raw/twinbot/nadekopm2setup.sh && bash "$root/nadekopm2setup.sh"
						echo ""
						echo "Welcome back..."
						sleep 2s
						bash "$root/linuxAIO.sh"
							...
							wget -N https://github.com/Kuromu/NadekoBot-BashScript/raw/twinbot/nadekobotpm2start.sh && bash "$root/nadekobotpm2start.sh"
							echo ""
							sleep 2s
							bash "$root/linuxAIO.sh"
							else
